...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div
      className="group relative h-full rounded-lg border border-border overflow-hidden bg-card hover:border-primary/50 transition-all duration-300"
      ...
      <div className="p-5 sm:p-6 space-y-4">
        ...
        <div className="flex gap-3 pt-4">
          <Link
            ...
            className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium bg-card border border-border text-foreground rounded-lg hover:bg-muted hover:border-primary/50 transition-all duration-300"
          >
